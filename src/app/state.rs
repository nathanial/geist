...
pub struct App {
    ...
    pub(crate) terrain_tile_cache_hits: VecDeque<u32>,
    pub(crate) terrain_tile_cache_misses: VecDeque<u32>,
    pub(crate) terrain_tile_cache_evictions: VecDeque<u32>,
    pub(crate) terrain_tile_cache_entries: VecDeque<u32>,
