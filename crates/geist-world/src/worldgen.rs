...
#[derive(Clone, Debug, Deserialize)]
pub struct Platform { #[serde(default = "default_platform_y_ratio")] pub y_ratio: f32, #[serde(default = "default_platform_y_offset")] pub y_offset: f32 }
...
#[derive(Clone, Debug, Deserialize)]
pub struct Height { #[serde(default = "default_height_freq")] pub frequency: f32, #[serde(default = "default_min_y_ratio")] pub min_y_ratio: f32, #[serde(default = "default_max_y_ratio")] pub max_y_ratio: f32 }
...
#[derive(Clone, Debug, Deserialize)]
pub struct Trees { #[serde(default = "default_tree_prob")] pub probability: f32, #[serde(default = "default_trunk_min")] pub trunk_min: i32, #[serde(default = "default_trunk_max")] pub trunk_max: i32, #[serde(default = "default_leaf_radius")] pub leaf_radius: i32 }
...
pub struct WorldGenParams {
    #[allow(dead_code)] pub mode_flat_thickness: i32,
...
impl WorldGenParams { pub fn default() -> Self { Self::from_config(&WorldGenConfig::default()) } }
...
impl BiomesParams {
    pub fn from(cfg: &Biomes) -> Self {
        let defs = cfg.biomes.iter().map(|b| BiomeDefParam {
            name: b.name.clone(),
        ...
        Self { temp_freq: cfg.temp.frequency, moisture_freq: cfg.moisture.frequency, defs, scale_x: cfg.scale_x, scale_z: cfg.scale_z, debug_pack_all: cfg.debug_pack_all, debug_cell_size: cfg.debug_cell_size }
    }
}
